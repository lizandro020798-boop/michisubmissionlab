...
const TESTIMONIALS = [
  ...
  {text:'"Empecé por falta de cardio: 2 luchas y ya no podía más. Hoy hago el doble de luchas consecutivas con más movilidad, lo que me permite enfocarme en la técnica y no depender tanto de la fuerza."', name:'Maximiliano Machuca', role:'Cinturón Azul BJJ · Competidor', initials:'MM', photo:'/img/testimonio-maxi.jpg'},
